...
class Customer(User):
    ...
    def display_profile(self):
        print(f"Customer name: {self.name}, E-mail: {self.email}")
...
class Chef(Employee):
    ...
    def display_profile(self):
        print(f"Chef name: {self.name}, Department: {self.department}")
...
class Server(Employee):
    ...
    def display_profile(self):
        print(f"Server name: {self.name}, Department: {self.department}")
...
class Manager(Employee): 
    ...
    def display_profile(self):
        print(f"Manager name: {self.name}, E-mail: {self.email}")